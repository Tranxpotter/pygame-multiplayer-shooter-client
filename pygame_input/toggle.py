...
class ToggleButtonRect(_ButtonRect):
    def __init__(self, x: int, y: int, width: int, height: int, border_radius: int = 0, color: tuple = ..., padding: int = 0, outline_color: tuple = ..., outline_width: int = 1, value=None, active: bool = True, state: bool = False) -> None:
        super().__init__(x, y, width, height, border_radius, color, padding, outline_color, outline_width, value, active)
        self.state = state
...
class ToggleButtonCircle(_ButtonCircle):
    def __init__(self, x: int, y: int, radius: int, color: tuple = ..., padding: int = 0, outline_color: tuple = ..., outline_width: int = 1, value=None, active: bool = True, state:bool = False) -> None:
        super().__init__(x, y, radius, color, padding, outline_color, outline_width, value, active)
        self.state = state
        self._on_toggle_on = None
        self._on_toggle_off = None
        self.set_on_click(self.toggle)
